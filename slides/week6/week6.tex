...
\begin{frame}[label={sec:orgbdbafc0}]{In-class Exercise Measurement}
...
\begin{frame}[label={sec:orgde2337b}]{In-class Exercise Measurement}
...
\begin{frame}[label={sec:org223df88}]{Poverty and economic decision-making}
...
\begin{frame}[label={sec:org65db8ea}]{Poverty and economic decision-making}
Load the poverty.csv data set.
\end{frame}

\begin{frame}[label={sec:orgd002fc7}]{Poverty and economic decision-making}
Variables:
\begin{itemize}
...
\begin{frame}[label={sec:orgb348987}]{Poverty and economic decision-making}
\alert{Question 1}
...
\begin{frame}[label={sec:orgd5d4b69}]{Poverty and economic decision-making}
\alert{Question 2a}
...
\begin{frame}[label={sec:orgcf367e1}]{Poverty and economic decision-making}
\alert{Question 2b}
...
\begin{frame}[label={sec:orge6ff227}]{Poverty and economic decision-making}
\alert{Question 3}
...
\begin{frame}[label={sec:org80296fc}]{Poverty and economic decision-making}
\alert{Question 4}
...
\begin{frame}[shrink=15,label={sec:org370d7b3}]{Poverty and economic decision-making}
\alert{Question 5}
...
\begin{frame}[label={sec:org165a269}]{Prediction}
\begin{center}
...
\begin{frame}[label={sec:orgf601efc}]{Prediction}
\begin{itemize}
...
\begin{frame}[label={sec:orgd0327f3}]{Prediction}
\begin{center}
...
\begin{frame}[label={sec:orgcf93f43}]{Prediction}
\begin{center}
...
\begin{frame}[label={sec:org5bbd2af}]{Prediction}
\begin{itemize}
...
\begin{frame}[label={sec:org8afd18d}]{Prediction with polls}
\begin{itemize}
...
\begin{frame}[fragile,shrink=15,label={sec:orgc532047}]{Prediction with polls}
 \begin{verbatim}
library(pollstR)
...
\begin{frame}[fragile,label={sec:orgce75b85}]{Prediction with polls}
 \begin{itemize}
...
\begin{frame}[fragile,shrink=25,label={sec:org48d9b4f}]{Prediction with polls}
...
\begin{frame}[label={sec:orgf87a89f}]{Prediction with polls}
\begin{center}
...
\begin{frame}[fragile,shrink=25,label={sec:orgb553e8d}]{Plotting polls}
 \begin{verbatim}
...
\begin{frame}[label={sec:org3ec20ef}]{Prediction with polls}
\begin{center}
...
\begin{frame}[label={sec:org1f4f13c}]{Prediction with polls}
\begin{itemize}
...
\begin{frame}[label={sec:org9e9ae62}]{Prediction with polls}
\begin{itemize}
...
\begin{frame}[label={sec:org7b4bc68}]{Creating a Moving Average}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:org6b66b24}]{Loops in R}
 \begin{verbatim}
for (i in X) {
    expression1
    expression2
...
\begin{frame}[label={sec:org4182189}]{Loops in R}
Elements of a loop:
\begin{itemize}
