...
\begin{frame}[label={sec:orgd756849}]{In-class Exercise Linear Regression}
...
\begin{frame}[label={sec:org4e46777}]{Variables in the intrade data}
\begin{itemize}
...
\begin{frame}[label={sec:org5144c61}]{Variables in the pres08 data}
\begin{itemize}
...
\begin{frame}[label={sec:org55baa31}]{Combining data sets}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:org9baca3b}]{Combining data sets}
 \begin{itemize}
...
\begin{frame}[label={sec:org0019c9e}]{Question 1}
...
\begin{frame}[fragile,shrink=20,label={sec:org3e32abf}]{Solution 1}
 \begin{verbatim}
...
\begin{frame}[label={sec:org94536f4}]{Question 2}
...
\begin{frame}[fragile,shrink=20,label={sec:orgdad1358}]{Solution 2}
 \begin{verbatim}
...
\begin{frame}[shrink=20,label={sec:org11ee0f1}]{Question 4}
...
\begin{frame}[fragile,shrink=20,label={sec:org5204b1a}]{Solution 4}
 \begin{verbatim}
...
\begin{frame}[label={sec:orgee752ab}]{Question 5}
...
\begin{frame}[fragile,shrink=25,label={sec:org3fcca66}]{Solution 5}
 \begin{verbatim}
stnames <- unique(intresults08$state.name)
...
\begin{frame}[label={sec:org66f1983}]{Questin 5}
...
\begin{frame}[fragile,shrink=25,label={sec:org050e536}]{Solution 5}
 \begin{verbatim}
