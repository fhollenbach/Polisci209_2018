...
\begin{frame}[fragile,label={sec:orgc3b94b1}]{Random Variables and Probability Distributions: Binomial Distribution}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org0f189bc}]{Random Variables and Probability Distributions: Binomial Distribution}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgfed2307}]{PMF and CDF}
...
\begin{frame}[label={sec:org591ecee}]{Random Variables and Probability Distributions: Binomial Distribution}
\begin{itemize}
...
\begin{frame}[fragile,shrink=35,label={sec:orga49a444}]{Random Variables and Probability Distributions: Binomial Distribution}
 \begin{verbatim}
x <- 0:3
...
\begin{frame}[label={sec:orgca4c973}]{Random Variables and Probability Distributions: Binomial Distribution}
\begin{center}
...
\begin{frame}[fragile,shrink=35,label={sec:org7da350a}]{Random Variables and Probability Distributions: Binomial Distribution}
 \begin{verbatim}
x <- -1:4
...
\begin{frame}[label={sec:orga2789f9}]{Random Variables and Probability Distributions: Binomial Distribution}
\begin{center}
...
\begin{frame}[label={sec:org592e025}]{Random Variables and Probability Distributions: Normal Distribution}
...
\begin{frame}[label={sec:org22faf0d}]{Random Variables and Probability Distributions: Normal Distribution}
...
\begin{frame}[label={sec:org48f2f15}]{Normal distribution}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:orgdae4942}]{Random Variables and Probability Distributions: Normal Distribution}
...
\begin{frame}[fragile,label={sec:org49fa151}]{Random Variables and Probability Distributions: Normal Distribution}
 \begin{itemize}
...
\begin{frame}[label={sec:orge6440f4}]{Normal distribution}
\begin{itemize}
...
\begin{frame}[label={sec:orgb2d4a33}]{Random Variables and Probability Distributions: Normal Distribution}
\begin{center}
...
\begin{frame}[fragile,shrink=30,label={sec:org6af5946}]{Random Variables and Probability Distributions: Normal Distribution in R}
 \begin{verbatim}
...
\begin{frame}[label={sec:orga6fa808}]{Random Variables and Probability Distributions: Normal Distribution in R}
\begin{center}
...
\begin{frame}[fragile,shrink=30,label={sec:org1be3f6b}]{Random Variables and Probability Distributions: Normal Distribution in R}
 \begin{verbatim}
...
\begin{frame}[label={sec:orga8a5b9a}]{Random Variables and Probability Distributions: Normal Distribution in R}
\begin{center}
...
\begin{frame}[label={sec:orgffc7549}]{Random Variables and Probability Distributions: Normal Distribution}
...
\begin{frame}[label={sec:org529db18}]{Random Variables and Probability Distributions: Normal Distribution}
...
\begin{frame}[fragile,shrink=30,label={sec:org3754d36}]{Random Variables and Probability Distributions: Normal Distribution}
 \begin{verbatim}
x <- seq(from = -7, to = 7, by = 0.01)
lwd <- 1.5
plot(x, dnorm(x), xlab = "x", ylab = "density", type = "l",
...
\begin{frame}[label={sec:org89cdec9}]{Random Variables and Probability Distributions: Normal Distribution}
\begin{center}
...
\begin{frame}[label={sec:org28f6639}]{Random Variables and Probability Distributions: Normal Distribution}
...
\begin{frame}[label={sec:orge32bd9b}]{Random Variables}
...
\begin{frame}[label={sec:org11bf46a}]{Means and Expectation}
...
\begin{frame}[label={sec:org12de81d}]{Means and Expectation}
...
\begin{frame}[label={sec:org0db51f0}]{Means and Expectation}
The expectation of a random variable is equal to the sum of all possibilities \emph{weighted} by the probabilities
...
\begin{frame}[label={sec:org50d8c2a}]{Means and Expectation}
...
\begin{frame}[label={sec:orgc9d9acd}]{Means and Expectation}
...
\begin{frame}[label={sec:org8024de8}]{Variance}
\begin{itemize}
...
\begin{frame}[label={sec:orgb1a9c5a}]{Variance}
