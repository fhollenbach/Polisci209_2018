...
\begin{frame}[label={sec:orge902037}]{Let's go to R-studio quick}
\end{frame}


\begin{frame}[label={sec:orgb17d2a5}]{Observational Studies and Causal Inference}
...
\begin{frame}[label={sec:orgd8ac83c}]{What is the Problem with Confounders?}
\pause
...
\begin{frame}[label={sec:org26ba627}]{Examples of Confounding}
\begin{itemize}
...
\begin{frame}[label={sec:org0738962}]{Examples of Confounding}
\begin{itemize}
...
\begin{frame}[label={sec:org95e2345}]{What can we do about confounding in observational studies?}
\pause
...
\begin{frame}[label={sec:org42f5cf8}]{Another problem with observational studies:}
\begin{itemize}
...
\begin{frame}[label={sec:orgb545b9b}]{Observational studies}
Difference-in-Differences Design
\end{frame}

\begin{frame}[label={sec:org9a97360}]{Difference-in-Differences Design}
\begin{itemize}
...
\begin{frame}[label={sec:org3dd7209}]{Difference-in-Differences Design}
\begin{itemize}
...
\begin{frame}[label={sec:org3bcff8e}]{Difference-in-Differences Design}
\begin{center}
\includegraphics[width=4cm]{/Users/florianhollenbach/Documents/GitHub/Polisci209_2018/slides/week3/Illustration_of_Difference_in_Differences.png}
\end{center}
...
\begin{frame}[label={sec:orga870f24}]{Difference-in-Differences Design}
\begin{center}
...
\begin{frame}[label={sec:org19da1f1}]{Describing numeric variables:}
\begin{itemize}
\item Mean
\item Median
\item Quantiles
...
\begin{frame}[label={sec:org6fbde41}]{Quantiles}
\begin{itemize}
...
\begin{frame}[label={sec:org9a48746}]{Describing the spread of numeric variables:}
\begin{itemize}
\item IQR:
\end{itemize}
...
\begin{frame}[label={sec:orgea57f3e}]{Describing the spread of numeric variables:}
Standard Deviation
...
\begin{frame}[label={sec:orgecf10e9}]{Standard Deviation}
\begin{center}
