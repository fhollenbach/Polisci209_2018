...
\begin{frame}[label={sec:org21bf665}]{Survey Sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org90bb114}]{Survey Sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org1679943}]{Survey Sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org2d83267}]{Literary Digest Sample}
\begin{itemize}
...
\begin{frame}[label={sec:org5519158}]{Quota Samping}
\begin{itemize}
...
\begin{frame}[label={sec:org4de649e}]{Simple Random Sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org08c7aae}]{Simple Random Sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org0b011d9}]{Simple Random Sampling}
\begin{itemize}
...
\begin{frame}[label={sec:org5a5f095}]{Simple Random Sampling}
\begin{itemize}
...
\begin{frame}[label={sec:orgf2c042e}]{Random Sampling is hard}
\begin{itemize}
...
\begin{frame}[label={sec:orge071b90}]{Non-reponse bias}
\begin{itemize}
...
\begin{frame}[label={sec:orge5e01c7}]{Non-reponse bias}
\begin{itemize}
...
\begin{frame}[label={sec:org1e27bfe}]{Why could this be a problem in the Afghanistan example?}
\begin{center}
\includegraphics[width=8cm]{/Users/florianhollenbach/Documents/GitHub/Polisci209_2018/slides/week5/afghan-survey.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga2ffdfd}]{Examples of Problems of Running Surveys in Afghanistan}
\begin{itemize}
\item unit non-response bias:
\end{itemize}
\pause
...
\begin{frame}[label={sec:orge47caaf}]{Strategies to Ask Sensitive Questions}
...
\begin{frame}[shrink=30,label={sec:orgc744be3}]{Strategies to Ask Sensitive Questions}
...
\begin{frame}[shrink=30,label={sec:org8197844}]{Strategies to Ask Sensitive Questions}
...
\begin{frame}[label={sec:org809cf42}]{Strategies to Ask Sensitive Questions}
\Large{List Experiments}
...
\begin{frame}[label={sec:orge08b873}]{Summarizing Bivariate Relationships}
\begin{itemize}
...
\begin{frame}[label={sec:orgadf85ff}]{Simple Summaries of Bivariate Relationships}
...
\begin{frame}[label={sec:orgab2293e}]{Simple Summaries of Bivariate Relationships}
...
\begin{frame}[label={sec:orgf183016}]{Simple Summaries of Bivariate Relationships: Scatterplot}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:org0f47ddc}]{Scatterplot}
 \begin{verbatim}
...
\begin{frame}[label={sec:org82dac66}]{Scatterplot}
...
\begin{frame}[label={sec:orgd385370}]{What do we do with skewed variables?}
\pause
\begin{itemize}
...
\begin{frame}[fragile,label={sec:orgd2e8af5}]{Scatterplot}
 \begin{verbatim}
plot(log(data$GDP),data$Child.Mortality)
\end{verbatim}
\end{frame}

\begin{frame}[label={sec:orgca107bd}]{Scatterplot}
\begin{center}
...
\begin{frame}[fragile,shrink=35,label={sec:org7775491}]{Scatterplot}
 \begin{verbatim}
...
\begin{frame}[label={sec:org90f1dc9}]{Scatterplot}
\begin{center}
\includegraphics[width=8cm]{/Users/florianhollenbach/Documents/GitHub/Polisci209_2018/slides/week5/scatter.pdf}
\end{center}
\end{frame}

\begin{frame}[fragile,shrink=55,label={sec:org6f877e9}]{Scatterplot -- more fun}
 \begin{verbatim}
...
\begin{frame}[label={sec:orgca1f17c}]{Scatterplot}
\begin{center}
...
\begin{frame}[label={sec:orgc830cf7}]{Bivariate Relationships in Numbers}
\begin{itemize}
...
\begin{frame}[label={sec:org1be569f}]{Calculating correlations -- Step 1: Standardizing a variable}
\begin{itemize}
