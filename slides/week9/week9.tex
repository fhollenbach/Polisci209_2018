...
\begin{frame}[label={sec:org5a58049}]{Why probability?}
\begin{itemize}
...
\begin{frame}[label={sec:orgd581fe5}]{Why probability?}
\begin{itemize}
...
\begin{frame}[label={sec:org47e36e0}]{Why probability?}
\begin{itemize}
...
\begin{frame}[label={sec:orga43ecc5}]{Two fundamental concepts of probability}
\begin{itemize}
...
\begin{frame}[label={sec:orgf63f858}]{Important Terms}
\begin{enumerate}
...
\begin{frame}[label={sec:org1480310}]{Axioms (rules) of Probability}
\begin{itemize}
...
\begin{frame}[label={sec:org53cb7db}]{Axioms (rules) of Probability}
...
\begin{frame}[label={sec:orgb6a76f7}]{Using the complement:}
...
\begin{frame}[label={sec:org9ea4ddc}]{Example of simple probability}
