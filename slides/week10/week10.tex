...
\begin{frame}[label={sec:org7e27083}]{Conditional Probability}
\begin{center}
...
\begin{frame}[label={sec:orgd9c8927}]{Conditional Probability}
...
\begin{frame}[label={sec:org3d0bbf9}]{Conditional Probability}
...
\begin{frame}[label={sec:org8bafc65}]{Independence}
...
\begin{frame}[label={sec:orgb1ec465}]{Independence}
...
\begin{frame}[label={sec:org7a3b4e9}]{Independence}
...
\begin{frame}[label={sec:org5d3494b}]{Conditional Probability}
P(A | B)

\emph{Probability of A given/conditional that B has happened}
\end{frame}

\begin{frame}[label={sec:org5f183ee}]{Conditional Probability}
...
\begin{frame}[label={sec:org7e019a3}]{Conditional Probability}
Definitions:
...
\begin{frame}[label={sec:orgb75501f}]{Conditional Probability}
P(rolled 5 then 6) = ?
...
\begin{frame}[label={sec:org9b9d56d}]{Conditional Probability}
...
\begin{frame}[label={sec:org289405d}]{Conditional Probability}
P(A | B) = \(\frac{P(A and B)}{P(B)}\)
...
\begin{frame}[label={sec:org1988bcb}]{Independence}
...
\begin{frame}[label={sec:orga9b683d}]{Independence}
...
\begin{frame}[label={sec:org6647aea}]{Probability Problems}
What is the probability of drawing any card between 2 and
10, or jack, queen, king in any color?
\end{frame}


\begin{frame}[label={sec:orgeebfbf8}]{Probability Problems}
...
\begin{frame}[label={sec:org91edc72}]{Probability Problems}
\begin{center}
\begin{tabular}{lrrr}
...
\begin{frame}[label={sec:orgf18ee9e}]{Probability Problems}
\begin{center}
\begin{tabular}{lrrr}
Annual income & Took 209 & Took 309 & TOTAL\\
Under \$50,000 & 36 & 24 & 60\\
...
\begin{frame}[label={sec:org82ad617}]{Probability Problems}
\begin{center}
\begin{tabular}{lrrr}
Annual income & Took 209 & Took 309 & TOTAL\\
Under \$50,000 & 36 & 24 & 60\\
...
\begin{frame}[label={sec:org5b4904d}]{Probability Problems}
\begin{center}
\begin{tabular}{lrrr}
Annual income & Took 209 & Took 309 & TOTAL\\
Under \$50,000 & 36 & 24 & 60\\
...
\begin{frame}[label={sec:orgf32782d}]{Probability Problems}
\begin{center}
\begin{tabular}{lrrr}
Annual income & Took 209 & Took 309 & TOTAL\\
Under \$50,000 & 36 & 24 & 60\\
...
\begin{frame}[label={sec:org4aa3d32}]{The Monty Hall Paradox!}
What is the Monty Hall Paradox?
\end{frame}


\begin{frame}[label={sec:orgf015e60}]{The Monty Hall Paradox!}
\begin{center}
...
\begin{frame}[label={sec:org6b2c99c}]{The Monty Hall Paradox!}
...
\begin{frame}[label={sec:orgaec39c7}]{The Monty Hall Paradox!}
What is the probability of winning a car when not switching?
...
\begin{frame}[label={sec:org91146fb}]{The Monty Hall Paradox!}
...
\begin{frame}[label={sec:org28d0b72}]{The Monty Hall Paradox: switching}
Consider two scenarios: picking door with car first and picking door with goat first
...
\begin{frame}[label={sec:org3b46f46}]{The Monty Hall Paradox: switching}
...
\begin{frame}[fragile,shrink=20,label={sec:org17b1685}]{The Monty Hall Paradox: in \emph{R}}
 \begin{verbatim}
sims <- 1000
...
\begin{frame}[label={sec:org4480609}]{Bayes' Rule/Theorem}
...
\begin{frame}[label={sec:orgbcecb0e}]{Bayes Rule/Theorem}
...
\begin{frame}[label={sec:org4019971}]{Bayes Rule/Theorem}
P(A | B) = \(\frac{P(B|A) P(A)}{P(B)}\)
...
\begin{frame}[label={sec:org41766dc}]{Bayes Rule/Theorem}
P(A | B) = \(\frac{P(B|A) P(A)}{P(B)} = \frac{P(B and A)}{P(B)}\)
\end{frame}



\begin{frame}[label={sec:orgb1e6811}]{Bayes Rule/Theorem}
P(A | B) = \(\frac{P(B|A) P(A)}{P(B)} = \frac{P(B|A) P(A)}{P(B|A)P(A) + P(B|A^{c})P(A^{c})}\)
\end{frame}


\begin{frame}[label={sec:orgaaab852}]{Bayes Rule/Theorem}
\begin{itemize}
...
\begin{frame}[label={sec:org32efe83}]{Bayes Rule/Theorem}
...
\begin{frame}[label={sec:org14e8de0}]{Bayes Rule/Theorem}
What is the probability of being pregnant, given that you have a positive test?

P(preg | + ) = \(\frac{P( + | p) P(p)}{P(+)} = \frac{P( + | p) P(p)}{P( + | p)P(p) + P( + | \text{not p})P(\text{not p})}\)
\end{frame}

\begin{frame}[label={sec:org9ca9062}]{Bayes Rule/Theorem}
What is the probability of being pregnant, given that you have a positive test?
...
\begin{frame}[label={sec:org3480647}]{Bayes Rule/Theorem}
...
\begin{frame}[label={sec:org1dc7740}]{Bayes Rule/Theorem}
But what happens if your prior probability is stronger?
...
\begin{frame}[label={sec:orgbd3f2f9}]{Bayes Rule/Theorem}
...
\begin{frame}[label={sec:orgbc9afb7}]{Bayes Rule/Theorem}
Many of our tests are not this good and disease is very rare:
...
\begin{frame}[label={sec:org00a5655}]{Random Variables and Probability Distributions}
\begin{itemize}
