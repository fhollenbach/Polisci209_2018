...
\begin{frame}[label={sec:org732ab87}]{Conditional Probability}
\begin{center}
...
\begin{frame}[label={sec:org6cc7716}]{Conditional Probability}
...
\begin{frame}[label={sec:org4b476c9}]{Conditional Probability}
...
\begin{frame}[label={sec:org9457825}]{Independence}
...
\begin{frame}[label={sec:org1aef7db}]{Independence}
...
\begin{frame}[label={sec:org532a271}]{Independence}
...
\begin{frame}[label={sec:org5d5b2f4}]{Conditional Probability}
P(A | B)

\emph{Probability of A given/conditional that B has happened}
\end{frame}

\begin{frame}[label={sec:org74d3979}]{Conditional Probability}
...
\begin{frame}[label={sec:org9950f19}]{Conditional Probability}
Definitions:
...
\begin{frame}[label={sec:org53f1dc6}]{Conditional Probability}
P(rolled 5 then 6) = ?
...
\begin{frame}[label={sec:org73ee05d}]{Conditional Probability}
...
\begin{frame}[label={sec:orga4c914d}]{Conditional Probability}
P(A | B) = \(\frac{P(A and B)}{P(B)}\)
