...
\begin{frame}[label={sec:org515ca21}]{Causal Inference}
\begin{block}{What do you think is causal inference?}
\end{block}
\end{frame}

\begin{frame}[label={sec:orge0cfd18}]{Causal Inference}
\begin{itemize}
...
\begin{frame}[label={sec:org50548c6}]{Causal Inference}
\begin{itemize}
\item Most questions that empirical (political) scientist are interested in are causal questions
\end{itemize}
\end{frame}

\begin{frame}[label={sec:orge2a402c}]{Causal Inference}
...
\begin{frame}[label={sec:orgd4542e0}]{Causal Inference}
\begin{block}{Examples from Political Science}
\begin{center}
